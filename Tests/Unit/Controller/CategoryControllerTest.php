...
/**
 * Test case for class BDAG\BdagTeamExtension\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \BDAG\BdagTeamExtension\Controller\CategoryController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('BDAG\\BdagTeamExtension\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView() {
		...
		$categoryRepository = $this->getMock('BDAG\\BdagTeamExtension\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenCategoryToView() {
		$category = new \BDAG\BdagTeamExtension\Domain\Model\Category();
